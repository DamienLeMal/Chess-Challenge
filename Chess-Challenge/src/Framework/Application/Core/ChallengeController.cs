...
namespace ChessChallenge.Application
{
    public class ChallengeController
    {
        ...
        public void StartNewGame(PlayerType whiteType, PlayerType blackType)
        {
            ...
            if (ForceFenPosition.Length != 0) board.LoadPosition(ForceFenPosition);
        ...
        ChessPlayer CreatePlayer(PlayerType type)
        {
            return type switch
            {
                ...
                PlayerType.Duck => new ChessPlayer(new DuckV1(), type, GameDurationMilliseconds),
        ...
        void EndGame(GameResult result, bool log = true, bool autoStartNextBotMatch = true)
        {
            ...
            if (isPlaying)
            {
                ...
                if (PlayerWhite.IsBot && PlayerBlack.IsBot)
                {
                    ...
                    botMatchGameIndex++;
                    int numGamesToPlay = TotalGameCount; // botMatchStartFens.Length * 2;
        ...
        public int TotalGameCount => NumberOfGames;//botMatchStartFens.Length * 2;
        ...
        public static ChessChallenge.API.IChessBot? CreateBot(PlayerType type) {
            return type switch {
                ...
                PlayerType.Duck => new DuckV1(),
                PlayerType.Test => new Test(),
